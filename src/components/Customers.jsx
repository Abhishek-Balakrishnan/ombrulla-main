    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-16 px-6 sm:py-20 lg:px-8">
        <div className="flex justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0000FF" className="w-2 h-2 mt-11">
        ...
        <h2 className="text-2xl font-bold text-center tracking-tight text">They Trust Us</h2>
