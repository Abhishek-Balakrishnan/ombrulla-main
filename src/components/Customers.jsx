    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-16 px-6 sm:py-20 lg:px-8">
        <div className="flex justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0000FF" className="w-2 h-2 mt-10">
            <path fillRule="evenodd" d="M4.5 7.5a3 3 0 013-3h9a3 3 0 013 3v9a3 3 0 01-3 3h-9a3 3 0 01-3-3v-9z" clipRule="evenodd" />
          </svg>
          <h4 className="text-center text-sm font-medium mt-9 font-sans mb-[1.125rem] p- mx-2">OUR CUSTOMERS</h4>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0000FF" className="w-2 h-2 mt-10">
            <path fillRule="evenodd" d="M4.5 7.5a3 3 0 013-3h9a3 3 0 013 3v9a3 3 0 01-3 3h-9a3 3 0 01-3-3v-9z" clipRule="evenodd" />
          </svg>
        </div>
        <h2 className="text-5xl font-medium text-center  font-sans tracking-tight mb-[1.125rem]">They Trust Us</h2>
